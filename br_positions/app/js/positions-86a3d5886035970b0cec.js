(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["positions"],{
...
/***/ "./src/javascript/app_2/Modules/Positions/Components/card_list.jsx":
/*!*************************************************************************!*\
  !*** ./src/javascript/app_2/Modules/Positions/Components/card_list.jsx ***!
  \*************************************************************************/
/*! no static exports found */
...
var _positions_card = __webpack_require__(/*! ./positions_card.jsx */ "./src/javascript/app_2/Modules/Positions/Components/positions_card.jsx");

var _positions_card2 = _interopRequireDefault(_positions_card);
...
var CardList = function CardList(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'card-list' },
        data.map(function (positions_position, id) {
            return _react2.default.createElement(_positions_card2.default, _extends({
                key: id
            }, positions_position, {
                currency: currency
            }));
...
/***/ "./src/javascript/app_2/Modules/Positions/Components/indicative_cell.jsx":
/*!*******************************************************************************!*\
  !*** ./src/javascript/app_2/Modules/Positions/Components/indicative_cell.jsx ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/javascript/app_2/Modules/Positions/Components/positions_card.jsx":
/*!******************************************************************************!*\
  !*** ./src/javascript/app_2/Modules/Positions/Components/positions_card.jsx ***!
  \******************************************************************************/
/*! no static exports found */
...
var PositionsCard = function PositionsCard(_ref) {
    ...
    return _react2.default.createElement(
        _reactRouterDom.NavLink,
        { className: 'positions-card card-list__card', activeClassName: 'active', to: (0, _helpers.getContractPath)(id) },
        _react2.default.createElement(
            'div',
            { className: 'positions-card__header' },
            _react2.default.createElement(
                'span',
                { className: 'positions-card__date' },
                _react2.default.createElement(_remaining_time2.default, { end_time: expiry_time })
            ),
            _react2.default.createElement(
                'span',
                { className: 'positions-card__refid' },
                reference
            )
        ),
        _react2.default.createElement(
            'div',
            { className: 'positions-card__body' },
            _react2.default.createElement(
                'div',
                { className: 'positions-card__desc' },
                details
            ),
            _react2.default.createElement(
                'div',
                { className: 'positions-card__row' },
                _react2.default.createElement(
                    'div',
                    { className: 'positions-card__cell positions-card__purchase' },
                    _react2.default.createElement(
                        'span',
                        { className: 'positions-card__cell-text' },
                        _react2.default.createElement(_money2.default, { amount: purchase, currency: currency })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'positions-card__cell positions-card__payout' },
                    _react2.default.createElement(
                        'span',
                        { className: 'positions-card__cell-text' },
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'positions-card__cell positions-card__indicative positions-card__indicative--' + status },
                    _react2.default.createElement(
                        'span',
                        { className: 'positions-card__cell-text' },
...
exports.default = PositionsCard;

/***/ }),

/***/ "./src/javascript/app_2/Modules/Positions/Constants/data_table_constants.js":
/*!**********************************************************************************!*\
  !*** ./src/javascript/app_2/Modules/Positions/Constants/data_table_constants.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
var _contract_type_cell = __webpack_require__(/*! ../Components/contract_type_cell.jsx */ "./src/javascript/app_2/Modules/Positions/Components/contract_type_cell.jsx");

var _contract_type_cell2 = _interopRequireDefault(_contract_type_cell);

var _indicative_cell = __webpack_require__(/*! ../Components/indicative_cell.jsx */ "./src/javascript/app_2/Modules/Positions/Components/indicative_cell.jsx");
...
/***/ "./src/javascript/app_2/Modules/Positions/Containers/positions.jsx":
/*!*************************************************************************!*\
  !*** ./src/javascript/app_2/Modules/Positions/Containers/positions.jsx ***!
  \*************************************************************************/
/*! no static exports found */
...
var _card_list = __webpack_require__(/*! ../Components/card_list.jsx */ "./src/javascript/app_2/Modules/Positions/Components/card_list.jsx");

var _card_list2 = _interopRequireDefault(_card_list);

var _empty_positions_message = __webpack_require__(/*! ../Components/empty_positions_message.jsx */ "./src/javascript/app_2/Modules/Positions/Components/empty_positions_message.jsx");

var _empty_positions_message2 = _interopRequireDefault(_empty_positions_message);

var _data_table_constants = __webpack_require__(/*! ../Constants/data_table_constants */ "./src/javascript/app_2/Modules/Positions/Constants/data_table_constants.js");
...
var Positions = function (_React$Component) {
    ...
    _createClass(Positions, [{
        ...
        value: function render() {
            ...
            if (is_empty) {
                return _react2.default.createElement(_empty_positions_message2.default, null);
            }
            ...
            return _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)('positions container', { 'positions--card-view': should_show_cards }) },
...
exports.default = (0, _connect.connect)(function (_ref) {
    ...
    return {
        ...
        totals: modules.positions.totals,
        onMount: modules.positions.onMount,
        onUnmount: modules.positions.onUnmount,
        is_mobile: ui.is_mobile,
        is_tablet: ui.is_tablet
    };
})((0, _reactRouterDom.withRouter)(Positions));

/***/ }),

/***/ "./src/javascript/app_2/Modules/Positions/index.js":
/*!*********************************************************!*\
  !*** ./src/javascript/app_2/Modules/Positions/index.js ***!
  \*********************************************************/
/*! no static exports found */
...
var _positions = __webpack_require__(/*! ./Containers/positions.jsx */ "./src/javascript/app_2/Modules/Positions/Containers/positions.jsx");

var _positions2 = _interopRequireDefault(_positions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _positions2.default;
