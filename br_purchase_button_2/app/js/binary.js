...
/******/ 	__webpack_require__.p = "/br_purchase_button_2/app/js/";
/******/
        ...
        switch (type) {
            ...
            case 'put':
                IconType = _react2.default.createElement(
                    ...
                    _react2.default.createElement('path', { fill: 'none', d: 'M0 0h16v16H0z' }),
                    _react2.default.createElement('path', { d: 'M0 0h16v16H0z' }),
                    _react2.default.createElement('path', { fill: '#FFF', d: 'M8.631 14.862c0-1.131.901-2.031 1.983-2.031h1.848L4.912 5.1V2.215l8.97 9.185V9.508c0-1.131.901-2.031 1.983-2.031v7.408H8.63v-.023z' }),
                    _react2.default.createElement('path', { fill: '#F93', d: 'M.045 2.215V.092h2.817l2.05 2.123z' })
                );
                break;
            default:
...
/***/ "./src/javascript/app_2/Assets/Trading/icon_profit_loss.jsx":
/*!******************************************************************!*\
  !*** ./src/javascript/app_2/Assets/Trading/icon_profit_loss.jsx ***!
  \******************************************************************/
/*! no static exports found */
...
exports.IconProfitLoss = undefined;
...
var IconProfitLoss = function IconProfitLoss(_ref) {
    var type = _ref.type;
    ...
    if (type) {
        switch (type) {
            ...
            case 'loss':
                ...
                break;
            default:
                IconType = _react2.default.createElement('path', { fill: '#E31C4B', fillRule: 'nonzero', d: 'M8 12l6-8H2z' });
                break;
        }
    }
    return _react2.default.createElement(
        'svg',
        { className: 'inline-icon', width: '16', height: '16', viewBox: '0 0 16 16', xmlns: 'http://www.w3.org/2000/svg' },
        IconType
    );
};

IconProfitLoss.propTypes = {
    type: _propTypes2.default.string
};

exports.IconProfitLoss = IconProfitLoss;
...
var _icon_profit_loss = __webpack_require__(/*! ../../../../../Assets/Trading/icon_profit_loss.jsx */ "./src/javascript/app_2/Assets/Trading/icon_profit_loss.jsx");
    ...
    return _react2.default.createElement(
        ...
        proposal_info.has_error || !proposal_info.id ? _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(_icon_profit_loss.IconProfitLoss, { type: proposal_info.profit >= 0 ? 'profit' : 'loss' })
            ),
            _react2.default.createElement(
                'span',
